...
class Model(object):
    ...
    def save(self):
        ...
        model.db[name].save(self.__dict__)
    ...
    def delete(self):
        ...
        model.db[name].update_one(query, {'$set': values})
        # self.deleted = True
        # self.save()
    ...
    def data_count(self, cls):
        ...
        count = model.db[name]._find(query).count()
        return count
